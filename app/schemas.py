"""This contains the schemas used in the database."""
...
class TestResult(Base):
    ...
    blocking_round_duration: Mapped[int] = mapped_column("blockingRoundDuration", Integer)
    cognitive_processing_index: Mapped[int] = mapped_column("cognitiveProcessingIndex", Integer)
    ...
    number_of_roll_mean_limit_exceedences: Mapped[int] = mapped_column("numberOfRollMeanLimitExceedences", Integer)
    ...
    total_machine_paced_answers: Mapped[int] = mapped_column("totalMachinePacedAnswers", Integer)
    total_machine_paced_correct_answers: Mapped[int] = mapped_column("totalMachinePacedCorrectAnswers", Integer)
    total_machine_paced_incorrect_answers: Mapped[int] = mapped_column("totalMachinePacedIncorrectAnswers", Integer)
    total_machine_paced_no_response_answers: Mapped[int] = mapped_column("totalMachinePacedNoResponseAnswers", Integer)
    quickest_response: Mapped[float] = mapped_column("quickestResponse", Float)
    quickest_correct_response: Mapped[float] = mapped_column("quickestCorrectResponse", Float)
    slowest_response: Mapped[float] = mapped_column("slowestResponse", Float)
    slowest_correct_response: Mapped[float] = mapped_column("slowestCorrectResponse", Float)
    mean_machine_paced_answer_time: Mapped[float] = mapped_column("meanMachinePacedAnswerTime", Float)
    mean_correct_machine_paced_answer_time: Mapped[float] = mapped_column("meanCorrectMachinePacedAnswerTime", Float)
...
class TestRound(Base):
    ...
    client_id: Mapped[str] = mapped_column(
        String,
        ForeignKey("cogspeed_test_result.client_id"),
        primary_key=True
    )
    test_id: Mapped[str] = mapped_column(
        String,
        ForeignKey("cogspeed_test_result.id"),
        primary_key=True
    )
